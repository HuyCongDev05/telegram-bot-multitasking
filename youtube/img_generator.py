...
<head>
    ...
    <style>
        ...
        body {{
            ...
            background-color: #e0e0e0; /* Nền trình duyệt */
            margin: 0;
            padding: 20px;
...
def generate_image(first_name, last_name):
    """
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page.wait_for_timeout(500)  # Đợi tải giao diện
...
if __name__ == '__main__':
    ...
    # Sửa lỗi mã hóa console trên Windows
    if sys.platform == 'win32':
        sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8')

    print("Đang kiểm tra tạo ảnh PSU...")
    ...
    try:
        ...
        print("✓ Đã lưu thành tệp test_psu_card.png")
